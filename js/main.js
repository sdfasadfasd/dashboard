...
(function () {
  ...
  function renderSupplier() {
    ...
    '</div>';
    html += '<div style="font-size:24px;color:#6678a0;margin-bottom:1px;">▎供应商列表</div>';
    ...
    list.forEach(function(s, i){
      ...
      items += '<div style="display:flex;align-items:center;gap:6px;padding:3px 0;border-bottom:1px solid rgba(255,255,255,0.03);font-size:24px;">' +
  ...
  function renderService() {
    ...
    body.innerHTML =
      ...
      '<div style="margin-top:2px;font-size:24px;color:#6678a0;text-align:center;">近7天服务人次趋势</div>' +
  ...
  function renderVehicle() {
    ...
    '</div>';
    html += '<div style="font-size:24px;color:#6678a0;margin-bottom:1px;">▎实时轨迹</div>';
    ...
    d.vehicles.forEach(function(v){
      ...
      items += '<div style="display:flex;align-items:center;gap:4px;padding:3px 0;border-bottom:1px solid rgba(255,255,255,0.03);font-size:24px;">' +
  ...
  function initMap() {
    ...
    if (typeof WUHAN_GEOJSON === 'undefined') {
      mapDom.innerHTML = '<div style="display:flex;align-items:center;justify-content:center;height:100%;color:#ff4081;font-size:24px;">地图数据缺失</div>';
      return;
    }
    mapDom.innerHTML = '';
