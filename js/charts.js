...
const Charts = (() => {
  ...
  function renderMap(domId, geoJSON, hubs, routes, vehicles) {
    ...
    // 厢式货车图标 (Phosphor style)
    var truckIcon = 'path://M0,8 L2,6 L2,3 L7,3 L7,2 L17,2 L17,3 L22,3 L22,6 L24,9 L24,13 L20,13 L20,14 L3,14 L3,13 L0,13 Z M8,12 A1.5,1.5 0 1,0 8,9 A1.5,1.5 0 1,0 8,12 M16,12 A1.5,1.5 0 1,0 16,9 A1.5,1.5 0 1,0 16,12 M14,2 L14,13';
