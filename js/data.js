...
const DataStore = (() => {
  ...
  /* ================ 物流节点 ================ */
  var HUB_LNGLAT = [ [114.21,30.25],[114.3090,30.6001],[114.3162,30.5435],[114.3438,30.5050],[114.1370,30.6200],[114.2180,30.5475],[114.3210,30.3510],[114.3750,30.8810],[114.0290,30.5820],[114.3940,30.6300],[114.8010,30.8500],[114.2650,30.5750],[114.4500,30.5000],[114.1800,30.4800] ];
  var DEFAULT_HUBS = [
  ...
  // 基于GeoJSON各区中心坐标（20辆车均匀分布）
  var FIXED_COORDS = [
    [114.303,30.595],[114.283,30.579],[114.265,30.571],[114.266,30.549],[114.307,30.547],
  ...
  function getVehicleData() {
    // 15个区中心 + 5个随机位置
    var centers = [[114.30,30.59],[114.28,30.58],[114.26,30.57],[114.26,30.55],[114.31,30.54],
      [114.39,30.63],[114.40,30.50],[114.14,30.62],[114.16,30.38],[114.08,30.55],
      [114.31,30.35],[114.37,30.87],[114.70,30.80],[114.42,30.52],[114.20,30.50]];
  ...
  function getMonthlySalesData() {
    return {
      ...
      values: [1578,476,1473,1357,1245,1248,459,0,0,0,0,0],
    };
  }
